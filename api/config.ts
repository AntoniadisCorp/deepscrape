...
const username = process.env['UPSTASH_REDIS_REST_USERNAME'] // Default username for Redis
...
// Set username if provided which should resolve the authentication issue with older Redis versions.
if (username) // Default username for Redis
