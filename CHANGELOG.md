...
* Merge branch 'main' into next ([cee387d](https://github.com/AntoniadisCorp/deepscrape/commit/cee387d))
...
* Merge branch 'next' of https://github.com/antoniadisCorp/deepscrape into next ([9d389eb](https://github.com/AntoniadisCorp/deepscrape/commit/9d389eb))
* Merge pull request #34 from AntoniadisCorp/next ([f019c2d](https://github.com/AntoniadisCorp/deepscrape/commit/f019c2d)), closes [#34](https://github.com/AntoniadisCorp/deepscrape/issues/34)
...
* Merge pull request #36 from AntoniadisCorp/next ([d1b723b](https://github.com/AntoniadisCorp/deepscrape/commit/d1b723b)), closes [#36](https://github.com/AntoniadisCorp/deepscrape/issues/36)
...
* Update package version from 0.3.0-beta.1 to 0.3.0 ([4b27226](https://github.com/AntoniadisCorp/deepscrape/commit/4b27226))
...
* ci(workflow): externalize api urls in firebase hosting workflows ([c302b37](https://github.com/AntoniadisCorp/deepscrape/commit/c302b37))
...
* chore(release): 0.3.0-beta.2 [skip ci] ([b9875a9](https://github.com/AntoniadisCorp/deepscrape/commit/b9875a9))
* chore(release): 0.3.0-beta.3 [skip ci] ([e493e98](https://github.com/AntoniadisCorp/deepscrape/commit/e493e98))
* chore(release): 0.4.0-beta.1 [skip ci] ([f33b496](https://github.com/AntoniadisCorp/deepscrape/commit/f33b496))
* chore(release): 0.4.0-beta.10 [skip ci] ([4528598](https://github.com/AntoniadisCorp/deepscrape/commit/4528598))
* chore(release): 0.4.0-beta.11 [skip ci] ([b32a878](https://github.com/AntoniadisCorp/deepscrape/commit/b32a878))
* chore(release): 0.4.0-beta.12 [skip ci] ([ff0755d](https://github.com/AntoniadisCorp/deepscrape/commit/ff0755d))
...
* chore(release): 0.4.0-beta.2 [skip ci] ([87b4d8b](https://github.com/AntoniadisCorp/deepscrape/commit/87b4d8b))
* chore(release): 0.4.0-beta.3 [skip ci] ([a735d6f](https://github.com/AntoniadisCorp/deepscrape/commit/a735d6f))
* chore(release): 0.4.0-beta.4 [skip ci] ([9215586](https://github.com/AntoniadisCorp/deepscrape/commit/9215586))
* chore(release): 0.4.0-beta.5 [skip ci] ([c973072](https://github.com/AntoniadisCorp/deepscrape/commit/c973072))
* chore(release): 0.4.0-beta.6 [skip ci] ([73107c6](https://github.com/AntoniadisCorp/deepscrape/commit/73107c6))
* chore(release): 0.4.0-beta.7 [skip ci] ([ca4f9d4](https://github.com/AntoniadisCorp/deepscrape/commit/ca4f9d4))
* chore(release): 0.4.0-beta.8 [skip ci] ([591cec8](https://github.com/AntoniadisCorp/deepscrape/commit/591cec8))
* chore(release): 0.4.0-beta.9 [skip ci] ([b9998c9](https://github.com/AntoniadisCorp/deepscrape/commit/b9998c9))
* chore(version): update version to 0.3.0 in package-lock.json ([1bd6170](https://github.com/AntoniadisCorp/deepscrape/commit/1bd6170))
* chore(version): update version to 0.3.0-beta.2 in package.json and clean up dataconnect.yml ([2422abd](https://github.com/AntoniadisCorp/deepscrape/commit/2422abd))
...
* feat: refactor API, landing page, and rate limiting ([3cb5e48](https://github.com/AntoniadisCorp/deepscrape/commit/3cb5e48))
...
* feat(components): integrate websocket for task status updates and enhance operations management ([f1dda1f](https://github.com/AntoniadisCorp/deepscrape/commit/f1dda1f))
* feat(crawlpack): improve service pack and ui components for improved profile and config management ([ad3b126](https://github.com/AntoniadisCorp/deepscrape/commit/ad3b126))
* feat(firestore): update csp and add firestore indexes ([8d5cc42](https://github.com/AntoniadisCorp/deepscrape/commit/8d5cc42))
* feat(footer): implement dynamic theme colors and enhance icon styling ([5486533](https://github.com/AntoniadisCorp/deepscrape/commit/5486533))
* feat(functions): this commit introduces a new API endpoint for cancelling tasks ([405a533](https://github.com/AntoniadisCorp/deepscrape/commit/405a533))
...
* feat(login): make trackLoginAttempt method asynchronous for improved browser detection ([0be516d](https://github.com/AntoniadisCorp/deepscrape/commit/0be516d))
* feat(neko): integrate Neko browser and WebRTC communication ([67105b9](https://github.com/AntoniadisCorp/deepscrape/commit/67105b9))
...
* feat(seeder): add seeder results component with new adimations and loggerservice ([4300e76](https://github.com/AntoniadisCorp/deepscrape/commit/4300e76))
...
* feat(ui): enhance tooltip component with animations and improved styling ([a85fa4f](https://github.com/AntoniadisCorp/deepscrape/commit/a85fa4f))
* fix: update background color in browser component and bump version to 0.4.0-beta.4 ([cde6646](https://github.com/AntoniadisCorp/deepscrape/commit/cde6646))
...
* fix(angular): add bootstrapcontext parameter to bootstrap function, to fix bootstrapcontext error ([ba12dfb](https://github.com/AntoniadisCorp/deepscrape/commit/ba12dfb))
* fix(api): update endpoint paths for task management in crawl api service and seeding service ([6822d46](https://github.com/AntoniadisCorp/deepscrape/commit/6822d46))
* fix(components): fix dropdown functionality and improve snackbar visibility ([c57b0fc](https://github.com/AntoniadisCorp/deepscrape/commit/c57b0fc))
* fix(config): enable postcss-import plugin and comment out v4 tailwindcss import ([42c597c](https://github.com/AntoniadisCorp/deepscrape/commit/42c597c))
...
* fix(pr): implement domain seeding, error logging, and client hydration ([f172ff9](https://github.com/AntoniadisCorp/deepscrape/commit/f172ff9))
...
* fix(tooltip): pass mouse event to onMouseEnter handler ([e29fe35](https://github.com/AntoniadisCorp/deepscrape/commit/e29fe35))
* refactor(aiapi): secure API key handling and bump version ([de58fd3](https://github.com/AntoniadisCorp/deepscrape/commit/de58fd3))
...
* refactor(depedencies): refine project configuration and hero section visuals ([324f1a9](https://github.com/AntoniadisCorp/deepscrape/commit/324f1a9))
* refactor(firebase): configure dataconnect, oub/sub emulator, and firestore ([29c3400](https://github.com/AntoniadisCorp/deepscrape/commit/29c3400))
* refactor(firestore): consolidate crawl config storage methods and improve error handling ([05c0a93](https://github.com/AntoniadisCorp/deepscrape/commit/05c0a93))
