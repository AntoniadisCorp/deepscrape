import { AdminEvents, ControlEvents, EVENT, FileTransferEvents, ScreenEvents, WebSocketEvents } from "./events.interface"
import { FileListItem, Member, ScreenConfigurations, ScreenResolution } from "./neko.types"
